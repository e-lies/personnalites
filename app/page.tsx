...
export default function Home() {
  ...
  return (
    <div className="h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 flex flex-col">
      <div className="max-w-4xl mx-auto w-full flex flex-col h-full">
        <h1 className="text-3xl font-bold text-gray-900 mb-8 text-center shrink-0">
          Excel File Processor
        </h1>

        <div className="bg-white shadow-md rounded-lg p-6 mb-6 shrink-0">
        ...
        {result && (
          <div className="bg-white shadow-md rounded-lg p-6 flex flex-col flex-grow overflow-hidden">
            <h2 className="text-xl font-bold text-gray-900 mb-4 shrink-0">
              Résultats ({result.length} lignes uniques)
            </h2>
